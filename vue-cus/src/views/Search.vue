    ...
    <header class="navbar">
        ...
        <div class="nav-links" :class="{ active: isMenuOpen }">
            ...
            <div class="nav-items">
                ...
                >
                <i :class="isRestaurant ? 'bi bi-shop' : 'bi bi-fast-forward-fill'" style="font-size: 1.3rem; color: white;"></i>
                </a>
...
const notifications = ref([
    { id: 1, title: '滿500折50', date: '2025-06-28', is_read: false },
    { id: 2, title: '會員限定免運券', date: '2025-06-27', is_read: false },
    { id: 3, title: '首次下單送折扣', date: '2025-06-26', is_read: true }
]);
