    ...
    <div class="user-dropdown-container">
        ...
        <span>{{ storeFullName ? storeFullName : '餐廳使用者*' }}</span>
        </a>
        <div class="dropdown-menu" v-if="showDropdown">
        <ul>
            <li @click="navigateTo('editStoreUser')">
                <i class="bi bi-person me-2"></i>餐廳業者資料</li>
            <li @click="navigateTo('editStore')">
                <i class="bi bi-shop me-2"></i>餐廳資料</li>
            <li @click="logout">
                <i class="bi bi-box-arrow-right me-2"></i>登出</li>
        </ul>
        </div>
        </div>
    </template>
