    <template>
        <div class="verify-bg d-flex justify-content-center align-items-center">
            ...
            <!-- 彈窗 -->
            <ChangeEmailDialog v-if="showChangeDialog" :show="showChangeDialog" :email="email"
                @close="showChangeDialog = false" @send="handleChangeEmail" />
        </div>
    </template>
...
import ChangeEmailDialog from '@/views/Ivy/ChangeEmailDialog.vue'
