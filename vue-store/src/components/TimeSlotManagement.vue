                ...
                <div v-else>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <select id="interval" v-model="timeSetting.interval" class="form-select" :disabled="saving">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="mealTime" v-model="timeSetting.mealTime" class="form-select" :disabled="saving">
                                <option value="30">30 分鐘</option>
                                <option value="60">60 分鐘</option>
                                <option value="90">90 分鐘</option>
                                <option value="120">120 分鐘</option>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <button @click="generateTimeSlots" class="btn btn-warning me-2" :disabled="saving">
...
const generateTimeSlots = async () => {
    ...
    try {
        const response = await fetch(`/api/stores/${props.storeId}/timeslots/generate?daysAhead=30`, {
            method: 'POST',
            headers: {
